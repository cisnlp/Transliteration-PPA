...
train_langs="eng_Latn,kor_Hang,zho_Hani,tha_Thai"

DATA_DIR="/mnt/data/ner/"
OUTPUT_DIR="/mnt/models_evaluation/ner/"
tokenized_dir="/mnt/models_evaluation/ner_tokenized"
...
srun --container-image=/dss/dsshome1/06/di35ver/containers/my_torch_container.sqsh \
  ...
  torchrun --standalone --nproc_per_node=1 /dss/dsshome1/06/di35ver/evaluation/tagging/evaluate_all_ner.py \
