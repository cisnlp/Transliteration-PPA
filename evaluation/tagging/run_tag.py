...
from transformers import (AdamW, RobertaConfig, RobertaForTokenClassification, RobertaTokenizer, WEIGHTS_NAME,
                ...
                if args.local_rank in [-1, 0] and args.save_steps > 0 and global_step % args.save_steps == 0:
                    if args.save_only_best_checkpoint:
                        ...
                        if result["f1"] > best_score:
                            ...
                            if 0 < args.eval_patience < patience:
...
def evaluate(args, model, tokenizer, labels, pad_token_label_id, mode, prefix="", lang="eng_Latn", lang2id=None,
             print_result=True):
...
def load_and_cache_examples(args, tokenizer, labels, pad_token_label_id, mode, lang, lang2id=None, few_shot=-1):
    ...
    cached_features_file = os.path.join(args.tokenized_dir,
                                        "cached_{}_{}_{}_{}".format(
                                            mode, lang,
                                            list(filter(None,
                                                        args.model_save_name.split(
                                                            "/"))).pop(),
    ...
    if args.do_predict and args.local_rank in [-1, 0]:
        ...
        with open(output_test_results_file, "w") as result_writer:
            for lang in args.predict_langs:
                ...
                idxfile = infile + '.idx'
                save_predictions(predictions, output_test_predictions_file, infile, idxfile)
...
def save_predictions(predictions, output_file, text_file, idx_file, output_word_prediction=False):
    # Save predictions
